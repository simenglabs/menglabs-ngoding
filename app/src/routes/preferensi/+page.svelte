...
<div class="min-h-screen bg-[#121827] px-4 py-10 text-white">
	<div class="mx-auto max-w-[680px]">
		...
		{#if draftLoaded}
			<p
				class="mt-2 inline-flex max-w-full items-center gap-2 rounded-full bg-[#1a2235] px-3 py-1 text-xs text-[#64748b]"
			>
		...
		<div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
			...
			>
				<div
					class="flex h-7 w-7 items-center justify-center rounded-lg bg-[#1a2a2b] text-[#c45a36]"
				>
					<!-- AI icon -->
					<svg
						width="16"
						...
						stroke="currentColor"
						stroke-width="1.8"
						><rect x="3" y="7" width="18" height="10" rx="3" /><path d="M8 11h.01" /><path
							d="M12 11h.01"
			...
			<button
				...
				{techMode === 'manual'
					...
					: 'border-[#2a3958] hover:border-[#334155]'}"
			>
				<div
					class="flex h-7 w-7 items-center justify-center rounded-lg bg-[#1a2a2b] text-[#c45a36]"
				>
					...
					<svg
						...
						stroke="currentColor"
						stroke-width="1.8"
						><path d="M12 3l7 4v8l-7 4-7-4V7z" /><circle cx="12" cy="12" r="2.5" /></svg
					>
				</div>
			...
			<div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
				...
				<div class="rounded-2xl border border-[#2a3958] bg-[#1e293b]/50 p-4">
					<div class="flex items-center gap-3">
						<span
							class="flex h-8 w-8 items-center justify-center rounded-xl bg-[#1e3a5f] text-blue-300"
						>
							<svg
								width="16"
								height="16"
								...
								stroke="currentColor"
								stroke-width="1.7"
								><rect x="3" y="4" width="18" height="14" rx="2" /><path d="M8 8h8" /><path
									d="M8 12h8"
								/><path d="M8 16h5" /></svg
							>
						</span>
				...
				<div class="rounded-2xl border border-[#2a3958] bg-[#1e293b]/50 p-4">
					<div class="flex items-center gap-3">
						<span
							class="flex h-8 w-8 items-center justify-center rounded-xl bg-[#0f3a2e] text-emerald-300"
						>
							<svg
								width="16"
								height="16"
								...
								stroke="currentColor"
								stroke-width="1.7"
								><path d="M12 22a7 7 0 0 0 7-7c0-3.5-3-6-7-11-4 5-7 7.5-7 11a7 7 0 0 0 7 7z" /><path
				...
				<div class="rounded-2xl border border-[#2a3958] bg-[#1e293b]/50 p-4">
					<div class="flex items-center gap-3">
						<span
							class="flex h-8 w-8 items-center justify-center rounded-xl bg-[#3a2f0f] text-amber-300"
						>
							<svg
								width="16"
								height="16"
				...
				<div class="rounded-2xl border border-[#2a3958] bg-[#1e293b]/50 p-4">
					<div class="flex items-center gap-3">
						<span
							class="flex h-8 w-8 items-center justify-center rounded-xl bg-[#2a1f4a] text-purple-300"
						>
							<svg
								width="16"
								height="16"
								...
								stroke="currentColor"
								stroke-width="1.7"
								><path d="M4.5 16.5c-1.5 1.3-1.5 3.5 0 5s3.7 1.5 5 0l5-5-5-5z" /><path
									d="M14 14l6-6a2 2 0 0 0 0-3l-1-1a2 2 0 0 0-3 0z"
								/><path d="M12 12l-2 2" /></svg
							>
						</span>
						<div>
